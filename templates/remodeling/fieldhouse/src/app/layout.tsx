...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${inter.variable} ${cormorant.variable} ${caveat.variable} antialiased`}
    >
      <body className="min-h-screen bg-warm-white text-ink font-sans selection:bg-terracotta/20 selection:text-ink">
        <ReactLenis root>
          {children}
        </ReactLenis>
      </body>
